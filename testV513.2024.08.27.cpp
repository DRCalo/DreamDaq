...
usleep(1000000);
    ...
    xio.setChannelInput(0);
    xio.setChannelInput(1);
    xio.setChannelOutput(2);
    xio.setChannelOutput(3);
    xio.setChannelOutput(4);
    xio.setChannelInput(5);
    xio.setChannelOutput(6);
    xio.setChannelInput(7);
